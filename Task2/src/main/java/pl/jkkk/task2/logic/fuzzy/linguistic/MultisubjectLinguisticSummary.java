...
public class MultisubjectLinguisticSummary<T> {
    ...
    public double degreeOfTruth() {
        final double p1tmp = 1.0 / objectsP1.size()
                * fuzzySetOfCompoundSummarizer.cardinality(objectsP1);
        final double p2tmp = 1.0 / objectsP2.size()
                * fuzzySetOfCompoundSummarizer.cardinality(objectsP2);
    ...
    public String toString() {
        ...
        return quantifier.getName() + " " + attributeValue1
                + " measurements compared to " + attributeValue2
